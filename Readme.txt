Instrucciones para Descargar un Repositorio y Ejecutar un Jupyter Notebook:
...
6-Crear y Activar un Entorno Virtual: 
	primero: python -m venv <nombre del ambiente>
	segundo:   - En Windows: <nombre del ambiente>\Scripts\activate
